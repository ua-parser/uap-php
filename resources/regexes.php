...
return [
    ...
    'device_parsers' => [
        [
            'regex' => '@^.{0,100}?(?:(?:iPhone|Windows CE|Windows Phone|Android).{0,300}(?:(?:Bot|Yeti)-Mobile|YRSpider|BingPreview|bots?/\\d|(?:bot|spider)\\.html|Google-InspectionTool)|AdsBot-Google-Mobile.{0,200}iPhone)@i',
            'device_replacement' => 'Spider',
            'brand_replacement' => 'Spider',
            'model_replacement' => 'Smartphone',
        ],
        [
            'regex' => '@^.{0,100}?(?:DoCoMo|\\bMOT\\b|\\bLG\\b|Nokia|Samsung|SonyEricsson).{0,200}(?:(?:Bot|Yeti)-Mobile|bots?/\\d|(?:bot|crawler)\\.html|(?:jump|google|Wukong)bot|ichiro/mobile|/spider|YahooSeeker)@i',
            'device_replacement' => 'Spider',
            'brand_replacement' => 'Spider',
        ...
        [
            'regex' => '@Android Application[^\\-]{1,300} - (?:HTC|HUAWEI|LGE|LENOVO|MEDION|TCT) (HTC|HUAWEI|LG|LENOVO|MEDION|ALCATEL)[ _\\-](.{1,200}) \\w{1,20} - @i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => '$1',
            'model_replacement' => '$2',
        ],
        ...
        [
            'regex' => '@; {0,2}AIRIS[ _\\-]?([^/;\\)]+) {0,2}(?:;|\\)|Build)@i',
            'device_replacement' => '$1',
            'brand_replacement' => 'Airis',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(OnePAD[^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
            'brand_replacement' => 'Airis',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@; {0,2}(?:alcatel[ _]|)(?:(?:one[ _]?touch[ _])|ot[ \\-])([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
        ...
        [
            'regex' => '@; {0,2}Aoson ([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'Aoson $1',
            'brand_replacement' => 'Aoson',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@; {0,2}(?:Axioo[ _\\-]([^;/]{1,100}?)|(picopad)[ _\\-]([^;/]{1,100}?))(?: Build|\\) AppleWebKit)@i',
        ...
        [
            'regex' => '@; {0,2}(IBAK\\-[^;/]*)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
        ...
        [
            'regex' => '@; {0,2}((?:Aquila|Clanga|Rapax)[^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
        ...
        [
            'regex' => '@; {0,2}(CUBE[ _])?([KU][0-9]+ ?GT.{0,200}?|A5300)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1$2',
            'brand_replacement' => 'Cube',
            'model_replacement' => '$2',
        ],
        [
            'regex' => '@; {0,2}CUBOT ([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
            'brand_replacement' => 'Cubot',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(BOBBY)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
            'brand_replacement' => 'Cubot',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@; {0,2}(Gionee)[ _\\-]([^;/]{1,100}?)(?:/[^;/]{1,100}|)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
        ...
        [
            'regex' => '@; {0,2}(andromax[^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'Hisense $1',
            'brand_replacement' => 'Hisense',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@(?:[;,] {0,2}|^)(?:htccn_chs-|)HTC[ _-]?([^;]{1,200}?)(?: {0,2}Build|clay|Android|-?Mozilla| Opera| Profile| UNTRUSTED|[;/\\(\\)]|$)@i',
            'device_replacement' => 'HTC $1',
            'brand_replacement' => 'HTC',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(A6277|ADR6200|ADR6300|ADR6350|ADR6400[A-Z]*|ADR6425[A-Z]*|APX515CKT|ARIA|Desire[^_ ]*|Dream|EndeavorU|Eris|Evo|Flyer|HD2|Hero|HERO200|Hero CDMA|HTL21|Incredible|Inspire[A-Z0-9]*|Legend|Liberty|Nexus ?(?:One|HD2)|One|One S C2|One[ _]?(?:S|V|X\\+?)\\w*|PC36100|PG06100|PG86100|S31HT|Sensation|Wildfire)(?: Build|[/;\\(\\)])@i',
            'device_replacement' => 'HTC $1',
            'brand_replacement' => 'HTC',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(ADR6200|ADR6400L|ADR6425LVW|Amaze|DesireS?|EndeavorU|Eris|EVO|Evo\\d[A-Z]+|HD2|IncredibleS?|Inspire[A-Z0-9]*|Sensation[A-Z0-9]*|Wildfire)[ _-](.{1,200}?)(?:[/;\\)]|Build|MIUI|1\\.0)@i',
            'device_replacement' => 'HTC $1 $2',
            'brand_replacement' => 'HTC',
            'model_replacement' => '$1 $2',
        ],
        ...
        [
            'regex' => '@; {0,2}(?:iBall[ _\\-]|)(Andi)[ _]?(\\d[^;/]*)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'iBall',
            'model_replacement' => '$1 $2',
        ],
        [
            'regex' => '@; {0,2}(IBall)(?:[ _]([^;/]{1,100}?)|)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'iBall',
            'model_replacement' => '$2',
        ],
        ...
        [
            'regex' => '@; {0,2}(IMO)[ _]([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'IMO',
            'model_replacement' => '$2',
        ],
        [
            'regex' => '@; {0,2}i-?mobile[ _]([^/]{1,50})(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'i-mobile $1',
            'brand_replacement' => 'imobile',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(i-(?:style|note)[^/]{0,10})(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'i-mobile $1',
            'brand_replacement' => 'imobile',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@; {0,2}(iOCEAN) ([^/]{1,50})(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
        ...
        [
            'regex' => '@; {0,2}Karbonn[ _]?([^;/]{1,100}) {0,2}(?:Build|;)@i',
            'device_replacement' => '$1',
        ...
        [
            'regex' => '@; {0,2}(Vox|VOX|Arc|K080)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
        ...
        [
            'regex' => '@; {0,2}(K-Touch)[ _]([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'Ktouch',
            'model_replacement' => '$2',
        ],
        [
            'regex' => '@; {0,2}((?:EV|KM)-S\\d+[A-Z]?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
        ...
        [
            'regex' => '@; {0,2}(?:LAVA[ _]|)IRIS[ _\\-]?([^/;\\)]+) {0,2}(?:;|\\)|Build)@i',
        ...
        [
            'regex' => '@; {0,2}(?:MD_|)LIFETAB[ _]([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
        ...
        [
            'regex' => '@; {0,2}(?:Micromax[ _](A111|A240)|(A111|A240)) Build@i',
            'device_replacement' => 'Micromax $1$2',
            'brand_replacement' => 'Micromax',
            'model_replacement' => '$1$2',
        ],
        [
            'regex' => '@; {0,2}Micromax[ _](A\\d{2,3}[^;/]*) Build@i',
            'device_replacement' => 'Micromax $1',
            'brand_replacement' => 'Micromax',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(A\\d{2}|A[12]\\d{2}|A90S|A110Q) Build@i',
            'device_replacement' => 'Micromax $1',
            'brand_replacement' => 'Micromax',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}Micromax[ _](P\\d{3}[^;/]*) Build@i',
            'device_replacement' => 'Micromax $1',
            'brand_replacement' => 'Micromax',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(P\\d{3}|P\\d{3}\\(Funbook\\)) Build@i',
            'device_replacement' => 'Micromax $1',
            'brand_replacement' => 'Micromax',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(MITO)[ _\\-]?([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'Mito',
            'model_replacement' => '$2',
        ],
        [
            'regex' => '@; {0,2}(Cynus)[ _](F5|T\\d|.{1,200}?) {0,2}(?:Build|[;/\\)])@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'Mobistel',
            'model_replacement' => '$1 $2',
        ],
        [
            'regex' => '@; {0,2}(MODECOM |)(FreeTab) ?([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1$2 $3',
            'brand_replacement' => 'Modecom',
            'model_replacement' => '$2 $3',
        ],
        [
            'regex' => '@; {0,2}(MODECOM )([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'Modecom',
            'model_replacement' => '$2',
        ],
        ...
        [
            'regex' => '@; {0,2}(Motoroi ?x|Droid X|DROIDX) Build@i',
            'device_replacement' => 'Motorola $1',
            'brand_replacement' => 'Motorola',
        ...
        [
            'regex' => '@; {0,2}(?:MSI[ _]|)(Primo\\d+|Enjoy[ _\\-][^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1',
        ...
        [
            'regex' => '@; {0,2}(A\\d+)[ _](Duo|)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => 'MyPhone',
            'model_replacement' => '$1 $2',
        ],
        ...
        [
            'regex' => '@; {0,2}(Nokia)([ _\\-]{0,5})([^;/]{0,50}) Build@i',
            'device_replacement' => '$1$2$3',
        ...
        [
            'regex' => '@; {0,2}(papyre)[ _\\-]([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1 $2',
        ...
        [
            'regex' => '@; {0,2}(Xperia (?:A8|Arc|Acro|Active|Live with Walkman|Mini|Neo|Play|Pro|Ray|X\\d+)[^;/]{0,50}) Build@i',
            'device_replacement' => '$1',
            'brand_replacement' => 'SonyEricsson',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@; {0,2}Android for (Telechips|Techvision) ([^ ]+) @i',
            'device_replacement' => '$1 $2',
            'brand_replacement' => '$1',
            'model_replacement' => '$2',
        ],
        ...
        [
            'regex' => '@; {0,2}(TREQ[ _\\-])([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => '$1$2',
            'brand_replacement' => 'Treq',
            'model_replacement' => '$2',
        ],
        ...
        [
            'regex' => '@(TOUCH(?:TAB|PAD).{1,200}?)(?: Build|\\) AppleWebKit)@i',
        ...
        [
            'regex' => '@; {0,2}(?:Walton[ _\\-]|)(Primo[ _\\-][^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'Walton $1',
            'brand_replacement' => 'Walton',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(?:WIKO[ \\-]|)(CINK\\+?|BARRY|BLOOM|DARKFULL|DARKMOON|DARKNIGHT|DARKSIDE|FIZZ|HIGHWAY|IGGY|OZZY|RAINBOW|STAIRWAY|SUBLIM|WAX|CINK [^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
        ...
        [
            'regex' => '@; {0,2}XOLO[ _]([^;/]{0,30}tab.{0,30})(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'Xolo $1',
            'brand_replacement' => 'Xolo',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}XOLO[ _]([^;/]{1,100}?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'Xolo $1',
            'brand_replacement' => 'Xolo',
            'model_replacement' => '$1',
        ],
        [
            'regex' => '@; {0,2}(q\\d0{2,3}[a-z]?)(?: Build|\\) AppleWebKit)@i',
            'device_replacement' => 'Xolo $1',
            'brand_replacement' => 'Xolo',
            'model_replacement' => '$1',
        ],
        ...
        [
            'regex' => '@(Android 3\\.\\d|Opera Tablet|Tablet; .{1,100}Firefox/|Android.{0,100}(?:Tab|Pad))@i',
            'device_replacement' => 'Generic Tablet',
            'brand_replacement' => 'Generic',
            'model_replacement' => 'Tablet',
        ],
